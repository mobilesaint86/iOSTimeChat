...
//  upload_files.php
//  DataSearch
//  Created by Rim Un Il on 28/07/2013.
//  Copyright (c) 2014 SinGi. All rights reserved.
...
class UploadHandler extends CI_Controller
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            'script_url' => $this->get_full_url().'/index.php/upload_files/index',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/xls/',
            'upload_url' => $this->get_full_url().'/xls/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $file = new stdClass();
		$pieces = explode(".", $name);
		 if ($pieces[count($pieces)-1] != "xls") return $file;
		$name = "customers.xls";
